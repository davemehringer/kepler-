...
#ifndef KEPLER_JUPITERFRAMEROTMATRIX_H_
#define KEPLER_JUPITERFRAMEROTMATRIX_H_
...
class JupiterFrameRotMatrix: public BodyFrameRotMatrix {
public:

    JupiterFrameRotMatrix();
